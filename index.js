...
(() => {
  ...
  var applySecond = function(dictApply) {
    ...
    return function(a3) {
      return function(b2) {
        return apply1(map19($$const(identity2))(a3))(b2);
      };
    };
  };
  ...
  var $$try = function(dictMonadError) {
    ...
    return function(a3) {
      return catchError1(map19(Right.create)(a3))(function($52) {
    ...
    return function(k) {
      var go2 = function(f) {
        ...
        if (v2 instanceof Return) {
          return map19(Done.create)(pure13(v2.value0));
        }
        ;
  ...
  var evalQ = function(render) {
    return function(ref2) {
      return function(q3) {
        return bind12(liftEffect4(read(ref2)))(function(v2) {
          return evalM(render)(ref2)(v2["component"]["eval"](new Query(map11(Just.create)(liftCoyoneda(q3)), $$const(Nothing.value))));
        });
      };
    };
  };
          ...
          return function(cqb) {
            return bind12(liftEffect4(read(ref2)))(function(v1) {
              return unChildQueryBox(function(v22) {
                ...
                return map13(v22.value2)(sequential2(v22.value0(applicativeParAff)(evalChild)(v1.children)));
              })(cqb);
            });
          };
        };
      ...
      return function(i2) {
        ...
        var render = function(lchs) {
          return function($$var2) {
            return function __do2() {
              var v2 = read($$var2)();
              var shouldProcessHandlers = map14(isNothing)(read(v2.pendingHandlers))();
  ...
  // output/Play/index.js
  var layout = function(v2) {
    return [];
  };
  ...
  var component = /* @__PURE__ */ function() {
    var renderItem = function(rect2) {
      return function(item) {
        return rect([x(rect2.x), y(rect2.y), width8(rect2.width), height8(rect2.height), fill(function() {
          if (item instanceof Blue) {
            return new RGB(0, 0, 150);
          }
          ;
          if (item instanceof Pink) {
            return new RGB(255, 0, 0);
          }
          ;
          if (item instanceof Yellow) {
            return new RGB(0, 255, 255);
          }
          ;
          throw new Error("Failed pattern match at Demo (line 70, column 29 - line 73, column 51): " + [item.constructor.name]);
        }())]);
      };
    };
    var render = function(examples) {
      return div2([])(map17(map18(map18(svg([width8(1e3), height8(1e3)]))(map17(uncurry(renderItem))))(layout))(examples));
    };
    var initialState = function(v2) {
      return theExamples;
    };
    var handleAction = $$const(pure(applicativeHalogenM)(unit));
    return mkComponent({
      initialState,
      render,
      "eval": mkEval({
